...
try:
  ...
  from google3.third_party.tensorflow.core.protobuf.tpu import compilation_result_pb2 as tpu_compilation_result
  ...
  from google3.third_party.tensorflow.python.distribute.cluster_resolver import tpu_cluster_resolver
  ...
  from google3.third_party.tensorflow.python.ops import batch_ops
  ...
  from google3.third_party.tensorflow.python.ops import control_flow_util
  ...
  from google3.third_party.tensorflow.python.tpu import functional as tpu_functional
  from google3.third_party.tensorflow.python.tpu import preempted_hook
  from google3.third_party.tensorflow.python.tpu import session_support
  from google3.third_party.tensorflow.python.tpu import tensor_tracer
  from google3.third_party.tensorflow.python.tpu import tpu
  from google3.third_party.tensorflow.python.tpu import tpu_embedding_gradient
  from google3.third_party.tensorflow.python.tpu import tpu_feed
  from google3.third_party.tensorflow.python.tpu import tpu_function
  from google3.third_party.tensorflow.python.tpu import training_loop
  ...
  from google3.third_party.tensorflow.python.util.tf_export import estimator_export
  from google3.third_party.tensorflow_estimator.python.estimator import estimator as estimator_lib
  from google3.third_party.tensorflow_estimator.python.estimator import model_fn as model_fn_lib
  from google3.third_party.tensorflow_estimator.python.estimator.export import export_output as export_output_lib
  from google3.third_party.tensorflow_estimator.python.estimator.tpu import _tpu_estimator_embedding
  from google3.third_party.tensorflow_estimator.python.estimator.tpu import error_handling
  from google3.third_party.tensorflow_estimator.python.estimator.tpu import iteration_count_estimator
  from google3.third_party.tensorflow_estimator.python.estimator.tpu import tpu_config
  from google3.third_party.tensorflow_estimator.python.estimator.tpu import tpu_context
  from google3.third_party.tensorflow_estimator.python.estimator.tpu import util as util_lib
  from google3.third_party.tensorflow_estimator.python.estimator.tpu._tpu_estimator_embedding import AdagradParameters  # pylint: disable=unused-import
  from google3.third_party.tensorflow_estimator.python.estimator.tpu._tpu_estimator_embedding import AdamParameters  # pylint: disable=unused-import
  from google3.third_party.tensorflow_estimator.python.estimator.tpu._tpu_estimator_embedding import EmbeddingConfigSpec  # pylint: disable=unused-import
  from google3.third_party.tensorflow_estimator.python.estimator.tpu._tpu_estimator_embedding import StochasticGradientDescentParameters  # pylint: disable=unused-import
...
_INITIAL_LOSS = 1e7
_ZERO_LOSS = 0.
_TPU_ESTIMATOR = 'tpu_estimator_xl'
...
class _ModelFnWrapper(object):
  ...
  def __init__(self, model_fn, train_cache_fn, eval_cache_fn, config, params,
               ctx):
...
class TPUEstimator(estimator_lib.Estimator):
  ...
  *should* raise an end-of-input exception (`OutOfRangeError` or
  ...
  def _augment_model_fn(self, model_fn, train_cache_fn, eval_cache_fn,
                        batch_axis):
