...
try:
  ...
  import google3.experimental.users.zihangd.pretrain.t5_input_func_builder as input_func_builder
  from google3.experimental.users.zihangd.pretrain.tokenization import get_tokenizer
except ImportError as e:
  print(e)
  import tensorflow as tf
  import t5_input_func_builder as input_func_builder
      ...
      for k, v in example_np.items():
        if v.ndim == 2:
          for i in range(v.shape[0]):
            if k in ["source", "target", "dec_inp", "inputs"]:
